...
<body>
    ...
    <div class="boardOuter">
        <table>
            <tr>
                <td colspan="3" width="1400px"><h5>[공지] 회의실 노트북 패스워드 변경 작업 안내</h5></td>
            </tr>
            <tr class="line">
                <td colspan="2">
                    <img src="resource/images/profile.jpg" class="rounded-circle" width="25" height="25">
                    문동은 팀장 
                    2023-02-16 (목) 16:35
                </td>
            ...
            <tr>
                ...
                <td colspan="2">
                    noticeFile.pdf <img src="resource/images/download.png" height="15px" width="15px"><br>
                    noticeFile2.pdf <img src="resource/images/download.png" height="15px" width="15px">
                </td>
            </tr>
            <tr>
                <td colspan="3">
