...
<body>
	...
	<div class="alarm-outer"> 
        <div id="alarm-menu">
            ...
            <div id="alarm-kind">
                <input type="radio" id="all" name="kind" checked><label for="all">전체 알림</label></input><br>
                <input type="radio" id="notRead" name="kind"><label for="notRead">안읽은 알림</label></input><br>
                <input type="radio" id="approval" name="kind"><label for="approval">결재</label></input><br>
                <input type="radio" id="work" name="kind"><label for="work">업무</label></input><br>
                <input type="radio" id="reservation" name="kind"><label for="reservation">예약</label></input><br>
                <input type="radio" id="commute" name="kind"><label for="commute">근태</label></input><br>
                <input type="radio" id="board" name="kind"><label for="board">게시판</label></input><br>
                <input type="radio" id="mail" name="kind"><label for="mail">메일</label></input><br>
            </div>
        </div>
        <div id="alarm-list">
            <br>
