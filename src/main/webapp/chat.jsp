        ...
        <div id="chat-header">
            <div id="chat-logo">
                ...
                <span style="float:right;">
                    홍길동&nbsp;
                    <img src="resource/images/profile.jpg" class="rounded-circle" width="25" height="25" id="myProfileImg">
                    <span class="conn out"></span> 
                </span>
            </div>
    
            <div id="chat-menu">
                <img src="resource/images/user.png" height="26px" onclick="showUser();"> 
                <img src="resource/images/messanger.png" height="25px" onclick="showChatting();"> 
            </div> 
        ...
        <div id="chat-body">
            ...
            <div id="college-area">
                <div class="detailView">
                    <img src="resource/images/right-arrow.png" height="15px" width="15px">&nbsp;
                    즐겨찾기
                </div>
                <div class="detail">
                    <div>
                        <img src="resource/images/profile.jpg" class="rounded-circle collegeProfileImg" width="25" height="25">
                        <span>
                            김혜수
                ...
                <div class="detailView">
                    <img src="resource/images/up-arrow.png" height="15px" width="15px">&nbsp;
                    내 부서
                </div>
                <div class="detail">
                    <div>
            ...
            <div id="chatRoomList-area">
                <table width="270">
                    <tr>
                        <td>
                            <img src="resource/images/profile.jpg" class="rounded-circle" width="40" height="40">
                        </td>
                        <td>
                            <b>김혜수</b> <br>
                            고마워요 길동씨~
            ...
            <div id="chatRoomCreate-area">
                <form action="">
                    <div class="detailView">
                        <img src="resource/images/down-arrow.png" height="15px" width="15px">&nbsp;
                        즐겨찾기
                    </div>
                    <div class="detail">
                        <div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <b>내 프로필</b><br><br>
                    <form action="">
                        <img src="resource/images/profile.jpg" class="rounded-circle" width="70" height="70">
                        <b>홍길동</b>
                        <select name="" id="">
                            <option value="">
                                온라인
    ...
    <div class="modal" id="collegeProfile" data-backdrop='static' data-keyboard='false'>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div align="center">
                    <img src="resource/images/profile.jpg" class="rounded-circle" width="150" height="150"><br><br>
